...
const Contact: React.FC = () => {
    ...
    return (
        <main className="bg-[#FFF4E8] p-16 lg:p-32">
            ...
            <div className="lg:grid lg:grid-cols-3 lg:gap-32 lg:justify-around">
                ...
                >
                    ...
                    <div className="lg:col-span-2">
                        <button
                            type="submit"
                            className="border border-[#383129] text-[#383129] bg-[#FFF4E8] py-2 px-4 rounded hover:bg-[#383129] hover:text-[#FFF4E8] poppins-regular"
                        >
                            Submit
                        </button>
                    </div>
